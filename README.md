...
A seguir estão as instruções originais do problema enviadas por e-mail:
...
As instruções para executar são similares as do projeto original.

1.  Clone este repositório
2.  Instale as dependências do monorepo `npm install`
3.  Instale as dependências de cada subprojeto com `npm install` ou execute o script `install.sh`
